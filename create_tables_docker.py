#!/usr/bin/env python3
"""
Скрипт для создания всех необходимых таблиц в Docker PostgreSQL
"""
...
async def create_all_tables_docker():
    """Создает все необходимые таблицы в Docker PostgreSQL"""
    try:
        # Подключаемся к Docker PostgreSQL
...
async def main():
    ...
    success = await create_all_tables_docker()
